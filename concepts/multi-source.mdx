...
description: "How the optional orchestrator router fans a question out across the SQL agent, document RAG, policy RAG, web search, and media sources — and synthesizes the results."
---
...
| Field | Type | Purpose |
|---|---|---|
| `route_decision` | `list[str]` | Which sources `classify_sources` selected for this question. |
